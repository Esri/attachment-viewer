...
define([
  ...
  "./MobileExpand/support/widgetSupport",
  ...
  var CSS = {
    ...
    expandCollapseIcon:
      "esri-mobile-expand__expand-collapse-icon icon-ui-flush",
  ...
  var Expand = /** @class */ (function (_super) {
    ...
    Expand.prototype.render = function () {
      ...
      var expandIconClasses =
        ((_a = {}),
        (_a[CSS.iconExpanded] = expanded),
        (_a[collapseIconClass] = expanded),
        (_a[expandIconClass] = !expanded),
        _a);
      var containerExpanded =
        ((_b = {}), (_b[CSS.containerExpanded] = expanded), _b);
      var contentClasses =
        ((_c = {}), (_c[CSS.contentExpanded] = expanded), _c);
      var maskClasses =
        ((_d = {}), (_d[CSS.expandMaskExpanded] = expanded), _d);
      var iconNumber = this.iconNumber;
      var badgeNumberNode =
        iconNumber && !expanded
          ? widget_1.tsx(
              "span",
              { key: "expand__icon-number", class: CSS.iconNumber },
              iconNumber
            )
          : null;
      var expandedBadgeNumberNode =
        iconNumber && expanded
          ? widget_1.tsx(
              "span",
              {
      ...
      return widget_1.tsx(
        "div",
        { class: this.classes(CSS.base, baseClasses, hide) },
        this.content.length > 0
          ? [
              ...
              widget_1.tsx(
                "div",
                { class: this.classes(CSS.container, containerExpanded) },
                widget_1.tsx(
                  "div",
                  { class: CSS.panel },
                  !expanded
                    ? widget_1.tsx(
                        ...
                        widget_1.tsx(
                          ...
                          widget_1.tsx("path", {
                            d:
                              "M7.5 6.786l4.5-4.5V3.7L7.5 8.2 3 3.7V2.286zM3 8.286V9.7l4.5 4.5L12 9.7V8.286l-4.5 4.5z"
                          })
                        ),
    ...
    Expand.prototype._renderContent = function () {
      ...
      var components = this.content.toArray().map(function (component) {
        if (widgetSupport_1.isWidget(component)) {
          return widget_1.tsx(
            "div",
            { key: component.id, class: CSS.mobileExpandComponent },
            component.render()
          );
        }
        return null;
      ...
      var expandedBadgeNumberNode =
        iconNumber && expanded
          ...
          : null;
      var collapseButton = ((_b = {}), (_b[CSS.collapseButton] = expanded), _b);
      return widget_1.tsx(
        "div",
        null,
        widget_1.tsx(
          "div",
          { class: this.classes(CSS.panel, collapseButton) },
          widget_1.tsx(
            "div",
            {
              bind: this,
            ...
            widget_1.tsx(
              ...
              widget_1.tsx("path", {
                d:
                  "M3 13.714V12.3l4.5-4.5 4.5 4.5v1.414l-4.5-4.5zm4.5-10.5l4.5 4.5V6.3L7.5 1.8 3 6.3v1.414z"
              })
            ),
            widget_1.tsx("span", { class: CSS.text }, title)
          ),
    ...
    tslib_1.__decorate(
      [decorators_1.property(), widget_1.renderable()],
      Expand.prototype,
      "collapseTooltip",
      void 0
    );
    ...
    tslib_1.__decorate(
      [decorators_1.aliasOf("viewModel.expanded"), widget_1.renderable()],
      Expand.prototype,
      "expanded",
      void 0
    );
    ...
    tslib_1.__decorate(
      [decorators_1.aliasOf("viewModel.view"), widget_1.renderable()],
      Expand.prototype,
      "view",
      void 0
    );
