...
define(["require", "exports", "esri/core/tsSupport/declareExtendsHelper", "esri/core/tsSupport/decorateHelper", "esri/core/accessorSupport/decorators", "esri/widgets/Widget", "esri/widgets/support/widget", "dojo/i18n!../PhotoCentric/nls/resources"], function (require, exports, __extends, __decorate, decorators_1, Widget, widget_1, i18n) {
    ...
    var OnboardingContent = /** @class */ (function (_super) {
        ...
        OnboardingContent.prototype.render = function () {
            var _a = this.config, onboardingHTML = _a.onboardingHTML, customOnboardingEnabled = _a.customOnboardingEnabled;
            return (widget_1.tsx("div", { innerHTML: customOnboardingEnabled
                    ? onboardingHTML
                        ? onboardingHTML
                        : null
                    : null }, customOnboardingEnabled ? null : (widget_1.tsx("div", null,
                widget_1.tsx("h2", { class: CSS.onboardingHeadingText }, i18n.welcome),
                widget_1.tsx("p", { class: CSS.onboardingContent }, "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magnam nostrum rerum aliquam veritatis? Similique omnis rerum quod perspiciatis laudantium error voluptatem, dolorum unde itaque. Sed unde magnam repellat repudiandae soluta."),
                widget_1.tsx("h2", { class: CSS.onboardingHeadingText }, i18n.about),
                widget_1.tsx("p", { class: CSS.onboardingContent }, "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Non dicta sint inventore. Nam magnam enim commodi in dolores perferendis fuga eligendi vero?"),
                widget_1.tsx("p", { class: CSS.onboardingContent }, "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Hic possimus accusamus quidem ullam dolorem molestiae at sequi ducimus. Nulla, maiores. Officia aspernatur quis corporis expedita quibusdam! Ullam suscipit distinctio tempora unde dolores, iste doloribus itaque nam adipisci asperiores repudiandae deleniti.")))));
        };
        __decorate([
