...
define(["require", "exports", "esri/core/tsSupport/declareExtendsHelper", "esri/core/tsSupport/decorateHelper", "dojo/i18n!./Share/nls/resources", "dojo/i18n!../../nls/common", "esri/core/watchUtils", "./utils/replace", "esri/core/accessorSupport/decorators", "esri/widgets/Widget", "esri/widgets/support/widget", "./Share/ShareViewModel", "esri/core/Handles"], function (require, exports, __extends, __decorate, i18n, i18nCommon, watchUtils, replace_1, decorators_1, Widget, widget_1, ShareViewModel, Handles) {
  "use strict";
  //----------------------------------
  //
  //  CSS Classes
  ...
  var Share = /** @class */ (function (_super) {
    ...
    Share.prototype._processShareItem = function (event) {
      ...
      this._handles.add(watchUtils.whenOnce(this, "shareUrl", function () {
        ...
        var title = portalItem ?
          replace_1.replace(i18n.urlTitle, {
            title: portalItem.title
          }) :
          null;
        var summary = portalItem ?
          portalItem && portalItem.snippet ?
          replace_1.replace(i18n.urlSummary, {
    ...
    Share.prototype._renderShareItems = function () {
      ...
      return shareServices
        .toArray()
        .map(function (shareItems) {
          return _this._renderShareItem(shareItems);
        });
    };
    Share.prototype._renderShareItemContainer = function () {
      ...
      return (widget_1.tsx("div", {
        class: CSS.shareItemContainerPhoto
      }, shareServices ? (widget_1.tsx("div", {
          class: CSS.shareModal.main.mainShare.shareContainer,
          key: "share-container"
        },
        widget_1.tsx("div", {
            class: CSS.shareModal.main.mainShare.shareItemContainer
          },
          shareItemNode,
          shareLink))) : null));
    };
    Share.prototype._renderShareLinkNode = function () {
      ...
      var shareLink = (_a = {},
        ...
        _a);
      return (widget_1.tsx("div", {
          class: this.classes(CSS.shareModal.main.mainShare.shareItem, CSS.shareLinkContainer, shareLink)
        },
        widget_1.tsx("div", {
          bind: this,
    ...
    Share.prototype._renderCopyUrl = function () {
      ...
      var toolTipClasses = (_a = {},
        ...
        _a);
      return (widget_1.tsx("div", {
        key: "send-link-container",
        class: CSS.sendLinkContainer
      }, copyToClipboard ? (widget_1.tsx("div", {
          class: CSS.shareModal.main.mainCopy.copyContainer,
          key: "copy-container"
        },
        widget_1.tsx("div", {
            class: CSS.shareModal.main.mainUrl.inputGroup
          },
          widget_1.tsx("h2", {
            class: CSS.shareModal.main.mainHeader
          ...
          widget_1.tsx("div", {
              class: CSS.shareModal.main.mainCopy.copyClipboardContainer
            },
            widget_1.tsx("input", {
              type: "text",
              class: CSS.shareModal.main.mainUrl.urlInput,
              bind: this,
              value: this.viewModel.state === "ready" ?
                this.shareUrl :
                i18nCommon.loading + "...",
              afterCreate: widget_1.storeNode,
            ...
            widget_1.tsx("div", {
              ...
              widget_1.tsx("svg", {
                ...
                widget_1.tsx("path", {
                  d: "M23 14v1H10.707l2.646 2.646-.707.707L8.793 14.5l3.854-3.854.707.707L10.707 14zm-5 2h1v7H1V4h4V3h3a2 2 0 0 1 4 0h3v1h4v9h-1V5h-3v2H5V5H2v17h16zM6 6h8V4h-3V2.615A.614.614 0 0 0 10.386 2h-.771A.614.614 0 0 0 9 2.615V4H6zm3 4H4v1h5zm-5 5h3v-1H4zm0 4h5v-1H4z"
                }))))))) : null));
    };
    Share.prototype._renderSendALinkContent = function () {
      ...
      return (widget_1.tsx("article", {
          class: CSS.mainLinkContainer
        },
        shareServicesNode,
