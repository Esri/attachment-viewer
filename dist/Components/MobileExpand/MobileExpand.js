...
define(["require", "exports", "esri/core/tsSupport/declareExtendsHelper", "esri/core/tsSupport/decorateHelper", "dojo/i18n!../../nls/common", "esri/core/accessorSupport/decorators", "esri/widgets/Widget", "esri/widgets/Expand/ExpandViewModel", "esri/widgets/support/widget", "./support/widgetSupport"], function (require, exports, __extends, __decorate, i18n, decorators_1, Widget, ExpandViewModel, widget_1, widgetSupport_1) {
  "use strict";
  ...
  var Expand = /** @class */ (function (_super) {
    ...
    Expand.prototype.render = function () {
      ...
      var badgeNumberNode = iconNumber && !expanded ? (widget_1.tsx("span", {
        key: "expand__icon-number",
        class: CSS.iconNumber
      }, iconNumber)) : null;
      var expandedBadgeNumberNode = iconNumber && expanded ? (widget_1.tsx("span", {
          ...
          widget_1.tsx("div", {
            ...
            !expanded ? (widget_1.tsx("div", {
              ...
              widget_1.tsx("svg", {
                ...
                widget_1.tsx("path", {
                  d: "M7.5 6.786l4.5-4.5V3.7L7.5 8.2 3 3.7V2.286zM3 8.286V9.7l4.5 4.5L12 9.7V8.286l-4.5 4.5z"
                })),
              widget_1.tsx("span", {
                class: CSS.text
              }, title))) : null,
    ...
    Expand.prototype._renderContent = function () {
      ...
      var components = this.content.map(function (component) {
        ...
        if (widgetSupport_1.isWidget(component)) {
          return (widget_1.tsx("div", {
            class: "esri-mobile-expand__component"
          }, component.render()));
        }
        ...
        widget_1.tsx("div", {
          ...
          widget_1.tsx("div", {
            ...
            widget_1.tsx("svg", {
              ...
              widget_1.tsx("path", {
                d: "M3 13.714V12.3l4.5-4.5 4.5 4.5v1.414l-4.5-4.5zm4.5-10.5l4.5 4.5V6.3L7.5 1.8 3 6.3v1.414z"
              })),
            widget_1.tsx("span", {
              class: CSS.text
            }, title)),
